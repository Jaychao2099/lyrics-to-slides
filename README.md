...
1. 從[發布頁面](https://github.com/Jaychao2099/lyrics-to-slides/releases)下載最新的 `lyrics-to-slides-setup-x.x.x.exe` 安裝檔 或 `Lyrics to Slides-x.x.x.exe` 免安裝執行檔（可跳過2. 3.）。*(請將 x.x.x 替換為最新版本號)*
2. 執行安裝檔，依照指示完成安裝。
...
1. 從[發布頁面](https://github.com/Jaychao2099/lyrics-to-slides/releases)下載最新的 `lyrics-to-slides-x.x.x.dmg` 鏡像檔。*(請將 x.x.x 替換為最新版本號)*
2. 開啟下載的鏡像檔。
3. 將應用程式拖曳至應用程式資料夾。
4. 在應用程式資料夾中啟動軟體。
